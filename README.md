...
- ventas-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- ventas-ui: main application module, development time
- ventas-production: module that produces a production mode WAR for deployment
