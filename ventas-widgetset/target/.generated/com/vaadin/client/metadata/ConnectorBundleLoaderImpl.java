      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setClass("com.ventas.ventas.samples.ResetButtonForTextField", com.ventas.ventas.client.samples.ResetButtonForTextFieldConnector.class);
          ...
          private void load1() {
            ...
            store.setConstructor(com.ventas.ventas.client.samples.ResetButtonForTextFieldConnector.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.ventas.ventas.client.samples.ResetButtonForTextFieldConnector.class);
              }
            });
          ...
          private void load2() {
            ...
            store.setReturnType(com.ventas.ventas.client.samples.ResetButtonForTextFieldConnector.class, "getState", new Type(com.vaadin.shared.communication.SharedState.class));
