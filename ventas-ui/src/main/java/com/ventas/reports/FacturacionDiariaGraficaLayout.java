...
public class FacturacionDiariaGraficaLayout extends VerticalLayout {
	...
	public FacturacionDiariaGraficaLayout() {
		setSizeFull();
		setCaption("Grafica de facturación por día");
		setSpacing(true);
		setMargin(false);
	...
	private ChartStreamSource getFacturacionDiariaChartStream(Date desde, Date hasta) {
		...
		List <FacturacionDia> listFacturacionDia = managePedido.listFacturacionDiaria(desde, hasta);
