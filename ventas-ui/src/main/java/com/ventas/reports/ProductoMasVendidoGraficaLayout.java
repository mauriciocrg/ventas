...
public class ProductoMasVendidoGraficaLayout extends VerticalLayout {
	...
	public ProductoMasVendidoGraficaLayout() {
		setSizeFull();
		setCaption("Grafica de producto mas vendido");
		setSpacing(true);
		setMargin(false);
	...
	private ChartStreamSource getFacturacionDiariaChartStream(Date desde, Date hasta) {
		...
		for(FacturacionProducto facturacionProducto: managePedido.listFacturacionPorProducto(desde, hasta)) {
